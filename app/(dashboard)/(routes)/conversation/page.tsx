    ...
    return (
        <div>
            ...
            <div className="px-6 lg:px-24 xl:px-60 w-full">
                <div className="fixed bg-blue-500/80 w-full bottom-0 left-0 pt-3 pb-[6dvh] sm:pb-20">
                ...
                <div className="flex flex-col justify-end h-[calc(84dvh-8rem)] sm:h-[calc(84dvh-8.5rem)] bg-red-500">
