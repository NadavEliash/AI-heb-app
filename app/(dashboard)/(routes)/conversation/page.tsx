    ...
    return (
        <div>
            ...
            <div className="px-6 lg:px-24 xl:px-60 w-full">
                <div className="fixed bg-gradient-to-t from-white from-95% to-transparent w-full bottom-0 left-0 pt-3 pb-12 sm:pb-20">
                ...
                <div className="flex flex-col justify-end h-[calc(100vh-15rem)] sm:h-[calc(100vh-18.5rem)]">
                    <div className="flex flex-col-reverse gap-y-4 overflow-y-scroll no-scrollbar">
                        <div className="w-full h-2 text-transparent">.</div>
